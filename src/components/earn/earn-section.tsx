...
export const EarnSection = () => {
	return (
		<div className="flex justify-between mb-[78px]">
			<div className="max-w-[628px]">
				...
				<p className="info mt-[14px] mb-[115px]">Authors receive tokens for every like and comment left by sponsors, thus creating an ecosystem of mutually beneficial interaction. This encourages quality creativity and active interaction between platform participants.</p>
				<a className="btn bg-black text-white text-[32px]" href="#!">Launch app</a>
				<a className="pl-[30px] text-[32px] leading-160 font-normal" href="#!">Learn more</a>
			</div>
